...
[plantuml, target=img/diagram-componet-package, format=png]
....
@startuml
package "前端" {
...
===== 某官网展示端组件图 home
[plantuml, target=img/diagram-comonent-dayu-home, format=png]
....
@startuml
...
.Express 展示端组件图
[plantuml, target=img/diagram-component-dayu1, format=png]
....
@startuml
...
.Express 展示端组件图
[plantuml, target=img/diagram-component-dayu2, format=png]
....
@startuml
...
.Express 展示端组件图
[plantuml, target=img/diagram-component-dayu3, format=png]
....
@startuml
left to right direction
...
.Express 展示端组件图
[plantuml, target=img/diagram-component-dayu4, format=png]
....
@startuml
package app.js {
